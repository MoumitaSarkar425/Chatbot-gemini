...
export default function Home() {
  return (
    // <div classNameName="flex flex-col font-mono items-center justify-center min-h-screen">
    //   <Head>
    //     <title>Chatbot + Gemini</title>
    //     <link rel="icon" href="/favicon.ico" />
    //   </Head>
    //   <form classNameName="flex flex-col w-full flex-1">
    //     <header classNameName="flex w-full h-24 fixed bg-black border-b">
    //       <span classNameName="flex items-center text-white font-bold text-lg p-2"> Chat Bot + Image Differentiation</span>
    //     </header>
    //     <div classNameName="flex flex-col	 mt-8 bg-gray-200 overflow-scroll p-2 w-full" style={{ height: "80vh"}} >

    //     </div>
    //     <footer classNameName="flex flex-row justify-between items-center items-center p-1 h-5/6  w-full -bottom-5">
    //       <input classNameName = " bg-gray-200 w-2/3 p-2 " placeholder="Type a message" />
    //       <span classNameName="flex items-center bg-gray-100 rounded rounded-l-none border-0 px-3 font-bold text-grey-100">
    //           <button classNameName="font-bold p-2 px-2 rounded">+</button>
    //       </span>
    //       <button classNameName = " bg-black p-2 ml-2 w-1/3  text-white" type="submit"> Send</button>
    //     </footer>
    //   </form>
    // </div>
          ...
          <div className="relative flex items-center space-x-4">
            ...
            <div className="flex flex-col leading-tight">
                <div className="text-2xl mt-1 flex items-center">
                  <span className="text-gray-700 mr-3">Chatbot + Gemini</span>
                </div>
            </div>
          </div>
          ...
          <div className="chat-message">
            <div className="flex items-end justify-end">
                <div className="flex flex-col space-y-2 text-xs max-w-xs mx-2 order-1 items-end">
                  ...
                  <div><span className="px-4 py-2 rounded-lg inline-block rounded-br-none bg-blue-600 text-white ">Run this command </span></div>
                </div>
                <img src="https://images.unsplash.com/photo-1590031905470-a1a1feacbb0b?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=facearea&amp;facepad=3&amp;w=144&amp;h=144" alt="My profile" className="w-6 h-6 rounded-full order-2"/>
            </div>
          </div>
